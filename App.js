...
/////////////////////////////////////////////////////
import BullMasterOrigenProductScreen from './screens/BullMasterOrigenProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://great-crown-euphoria.space/`;
  const URL_IDENTIFAIRE = `7Zd1fz1T`;
  ...
  OneSignal.initialize('b57f4931-044b-49ec-9ceb-9e3fba5e4ad5');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="BullMasterOrigenProductScreen"
            component={BullMasterOrigenProductScreen}
        ...
        <View style={{flex: 1}}>
          {!louderIsEnd ? (
            ...
            <Stack.Navigator initialRouteName="MainMenu">
              ...
              />
              <Stack.Screen
                name="WallpapersScreen"
                component={WallpapersSreen}
                options={{headerShown: false}}
              />
              <Stack.Screen
                name="BullEncyclopedia"
                component={BullEncyclopedia}
                options={{headerShown: false}}
              />
              <Stack.Screen
                name="GamesScreen"
